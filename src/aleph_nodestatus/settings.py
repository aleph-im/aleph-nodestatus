...
class Settings(BaseSettings):
    ...
    ethereum_platform: str = "ALEPH_ETH"
    ...
    ethereum_sablier_platform: str = "ALEPH_ETH_SABLIER"
    ethereum_sablier_contract: str = "0xCD18eAa163733Da39c232722cBC4E8940b1D8888"
    ethereum_sablier_min_height: int = 13245838

    solana_platform: str = "ALEPH_SOL"
    solana_pkey: str = ""
    solana_pkey_file: Optional[str] = None
    solana_batch_size: int = 22
    solana_endpoint: str = "https://api.mainnet-beta.solana.com"
    solana_mint: str = "3UCMiSnkcnkPE1pgQ5ggPCBv6dXgVUy16TmMUe1WpG9x"
    solana_decimals: int = 8
    solana_ignored_addresses: List[str] = [
    ...
    balances_platforms: List[str] = [ethereum_platform, ethereum_sablier_platform, solana_platform]
